...
st.set_page_config(
    page_title="Student Mental Health Burnout Prediction",
    page_icon="🧠",
    layout="wide"
)
...
st.title("🧠 Student Mental Health Burnout Prediction App")
st.write(
    "Aplikasi ini digunakan untuk memprediksi tingkat burnout mahasiswa "
    "berdasarkan data mental health, kebiasaan belajar, tidur, aktivitas, dan akademik."
)
...
if menu == "Prediksi Manual":
    ...
    st.write("Masukkan nilai fitur student mental health secara manual.")
    ...
    if st.button("Prediksi Data Manual"):
        try:
            ...
            if hasattr(model, "predict_proba"):
                ...
                st.info("Model ini tidak memiliki fungsi predict_proba.")
    ...
    st.write(
        ...
        "File harus memiliki kolom fitur yang sesuai dengan dataset student mental health."
    )
                    ...
                    if st.button("Prediksi Data CSV/Excel"):
                        try:
                            ...
                            st.download_button(
                                ...
                                data=csv_result,
                                file_name="hasil_prediksi_student_burnout.csv",
                                mime="text/csv"
                            )
